...
export default function Create({ locations }: CreateProps) {
    const { data, setData, post, processing, errors } = useForm({
        name: '', asset_type: 'onu_ont', serial_number: '', mac_address: '',
        ip_address: '', management_ip: '', location_id: '', ownership: 'owned',
        vendor: '', model: '', purchase_date: '', purchase_price: '', warranty_expiry: '', notes: '',
    });

    const submit = (e: FormEvent) => { e.preventDefault(); post(route('admin.network-assets.store')); };

    return (
        <AdminLayout title="Create Network Asset">
            <form onSubmit={submit}>
                <Card>
                    <CardHeader><CardTitle>Create Network Asset</CardTitle></CardHeader>
