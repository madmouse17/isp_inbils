    ...
    return (
        <AdminLayout title="Create SLA Tier">
            <form onSubmit={submit}>
                <Card>
                    <CardHeader><CardTitle>Create SLA Tier</CardTitle></CardHeader>
                    ...
                    <CardFooter className="justify-end gap-2">
                        <Button type="button" variant="secondary" onClick={() => router.get(route('admin.sla-tiers.index'))}>Cancel</Button>
