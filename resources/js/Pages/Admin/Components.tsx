...
export default function Components() {
    ...
    return (
        <AdminLayout title="Galeri Komponen">
            <div className="mx-auto flex max-w-7xl gap-8 p-6 lg:p-8">
                <nav className="sticky top-8 hidden w-56 shrink-0 space-y-1 self-start lg:block">
                    {sections.map((s) => (
                        <a
                            key={s.id}
                            href={`#${s.id}`}
                    ...
                    <section id="inputs" className="scroll-mt-8">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Kontrol input teks, area, select, checkbox, switch, radio.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <p className="text-sm text-surface-600 dark:text-surface-400">
                                                Card content with semantic copy.
                                            </p>
                                        </CardContent>
                                        <CardFooter>
                    ...
                    <section id="layout" className="scroll-mt-8">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Sidebar dan topbar (sedang dipakai di halaman ini via
                                    AdminLayout).
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <p className="text-sm text-surface-600 dark:text-surface-400">
                                    Sidebar dan Topbar aktif di seluruh halaman admin. Lihat kiri
                                    dan atas.
                                </p>
