...
import { Badge, Button, Card, CardContent, Select, Pagination, Table, TBody, TD, TH, THead, TR } from '@/Components/ui';
        ...
        <AdminLayout title="Stock Movements">
            <div className="space-y-6">
                <PageHeader
                    ...
                    actions={<Button type="button" variant="secondary" onClick={() => router.get(route('admin.stocks.index'))}>Stocks</Button>}
                />
                <Card>
