        ...
        <AdminLayout title="Users">
            <div className="space-y-6">
                <PageHeader
                    ...
                    actions={can.create && <Button type="button" onClick={() => router.get(route('admin.users.create'))}>Create User</Button>}
                />
                    ...
                    <CardContent className="space-y-4 pt-6">
                        ...
                        <Table>
                            ...
                            <TBody>
                                {users.data.length === 0 ? (
                                    <TR>
                                        <TD colSpan={5} className="py-10 text-center text-muted-foreground">No data found.</TD>
                                    </TR>
                                ) : (
                                    users.data.map((user) => (
                                        <TR key={user.id}>
